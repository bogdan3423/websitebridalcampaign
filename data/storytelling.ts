  ...
  steps: [
    {
      ...
      media: {
        type: "image",
        src: portfolio("portret-bridal-voal-manusi"),
    ...
    },
    {
      ...
      media: {
        type: "image",
        src: portfolio("portret-modela-blonda-editorial"),
    ...
    },
    {
      ...
      media: {
        type: "image",
        src: portfolio("modela-bruneta-voal-editorial"),
    ...
    },
    {
      ...
      media: {
        type: "image",
        src: portfolio("rochie-mireasa-interior-clasic"),
    ...
    },
    {
      ...
      media: {
        type: "image",
        src: portfolio("rochie-mireasa-vazuta-din-spate"),
  ...
  steps: [
    {
      ...
      media: { type: "image", src: portfolio("portret-modela-blonda-editorial"), alt: "Cadru editorial potrivit pentru un video cu prezentator", position: "center 20%" },
    },
    {
      title: "Model + rochie",
      copy: "Cadre cinematice cu modelul purtând rochia: mers, mișcare, voal și cadre principale.",
      media: { type: "image", src: portfolio("model-rochie-mireasa-satin-editorial"), alt: "Modelă purtând o rochie de mireasă din satin în mișcare", position: "center 28%" },
    },
    {
      title: "Detail",
      copy: "Corset, dantelă, trenă, broderii, texturi și detalii care nu se văd într-un cadru general.",
      media: { type: "image", src: portfolio("rochie-mireasa-satin-pe-trepte"), alt: "Detaliu editorial al unei rochii de mireasă din satin", position: "center 32%" },
    },
    {
      title: "Educational",
      copy: "Sfaturi pentru mirese, diferențe între croieli și conținut care poziționează salonul ca expert.",
      media: { type: "image", src: portfolio("modela-bruneta-voal-editorial"), alt: "Portret bridal pentru un format video educațional", position: "center 20%" },
    },
    {
      title: "Showroom / location",
      copy: "Prezentăm atmosfera salonului sau a locației, nu doar rochia.",
      media: { type: "image", src: portfolio("rochie-mireasa-interior-clasic"), alt: "Rochie de mireasă prezentată într-un interior clasic", position: "center 26%" },
    },
    {
      title: "Comparison",
      copy: "Rochia A sau B, princess sau mermaid, satin sau dantelă.",
      media: { type: "image", src: portfolio("rochie-mireasa-vazuta-din-spate"), alt: "Cadru din spate pentru compararea detaliilor unei rochii", position: "center 24%" },
    },
    {
      title: "Trend / social-first",
      copy: "POV, tranziții și formate construite pentru social media.",
      media: { type: "image", src: portfolio("modela-rochie-mireasa-voal-trepte"), alt: "Cadru bridal dinamic potrivit pentru social media", position: "center 24%" },
    },
    {
      title: "Sales / CTA",
      copy: "Colecții noi, disponibilitate și invitații către programarea unei probe.",
      media: { type: "image", src: portfolio("model-rochie-mireasa-satin-editorial"), alt: "Cadru principal de campanie pentru promovarea unei colecții", position: "center 28%" },
    },
    {
      title: "BTS",
      copy: "Makeup, hair, pregătirea modelului și atmosfera din ziua producției.",
      media: { type: "image", src: portfolio("modela-bruneta-voal-editorial"), alt: "Portret bridal din pregătirea unei producții", position: "center 20%" },
    },
  ],
};
